use crate::{Config, db::{component::component::Component, db::DB}, server::{db_api::{class::{get_all_classes::get_all_classes, post_class::post_class, post_class_instance_id_get_class::post_class_instance_id_get_class}, class_instance::{get_class_instance_descendants::post_id_get_class_instance_descendants, post_class_instance::post_class_instance, post_class_instance_id_get_fields::post_class_instance_id_get_fields, post_class_instance_id_get_fields_for_html::post_class_instance_id_get_fields_for_html}, component::{post_component::{self, post_component}, post_component_with_files::post_component_with_files, post_id_get_component::post_id_get_component, post_id_get_component_with_attributes::post_id_get_component_with_attributes, post_search_get_component_with_attributes::post_search_get_component_with_attributes, post_search_get_facets::post_search_get_facets}, files::{get_image_full::get_image_full, get_image_thumb::get_image_thumb}, label::{get_all_labels::get_all_labels, post_label::post_label}, manufacturer::{get_all_manufacturers::get_all_manufacturers, post_manufacturer::post_manufacturer}, origin::{get_all_origins::get_all_origins, post_origin::post_origin}}, embedded_dir::{self}, label_api::post_build_label, python_api::post_qr_python_to_origin::post_qr_python_to_origin}};
...
fn api() -> Router<Arc<ServerState>>{
    let api: Router<Arc<ServerState>> = Router::new()
        ...
        .route("/post_id_get_component_with_attributes", post(post_id_get_component_with_attributes))
        ...
        // IMAGE
        .route("/get_image_thumb/{component_id}", get(get_image_thumb))
        .route("/get_image_full/{component_id}", get(get_image_full))
